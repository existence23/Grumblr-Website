...
urlpatterns = [
    ...
    path('grumblr/check-profile/delete-post/<int:post_id>', views.delete_post),
    ...
    path('grumblr/check-profile/follow/<int:post_id>', views.follow),
    path('grumblr/check-profile/unfollow/<int:post_id>', views.unfollow),
    ...
    # changed
    url(r'^grumblr/get-changes/?$', views.get_changes),
    url(r'^grumblr/get-changes/(?P<origin_time>.+)$', views.get_changes),
    url(r'^grumblr/get-posts/?$', views.get_posts),
    url(r'^grumblr/get-posts/(?P<origin_time>.+)$', views.get_posts),
    url(r'^grumblr/follower/get-changes/?$', views.follower_get_changes),
    url(r'^grumblr/follower/get-changes/(?P<origin_time>.+)$', views.follower_get_changes),
    url(r'^grumblr/follower/get-posts/?$', views.follower_get_posts),
    url(r'^grumblr/follower/get-posts/(?P<origin_time>.+)$', views.follower_get_posts),
    path('grumblr/create-comment/', views.comment),
    path('grumblr/get-comments/<int:post_id>', views.get_comments),
    path('grumblr/check-profile/create-comment/', views.comment),
    path('grumblr/check-profile/get-comments/<int:post_id>', views.get_comments),
    url(r'^grumblr/check-profile/posts/(?P<user_id>.+)$', views.get_profile_posts),
